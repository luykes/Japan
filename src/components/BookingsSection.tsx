          ...
          {showForm ? (
            <div className="glass rounded-2xl p-5 border border-pink-500/30 bg-gradient-to-br from-pink-900/10 to-transparent">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                ...
                />
                <input placeholder="Date (e.g. 20 May 2025)" value={form.date} onChange={(e) => setForm((p) => ({ ...p, date: e.target.value }))} className="bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-pink-500/50" />
